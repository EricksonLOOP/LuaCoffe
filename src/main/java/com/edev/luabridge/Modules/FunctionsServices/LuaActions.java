...
public class LuaActions {
    ...
    public String waitingValueOfScript(String script, Map<String, Object> params, String path ){
    ...
    public String executeLuaCode(String script, Map<String, Object> params, String path){
        try{
